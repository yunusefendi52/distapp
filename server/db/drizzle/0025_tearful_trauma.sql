...
ALTER TABLE `apps` ALTER COLUMN "createdAt" TO "createdAt" integer;--> statement-breakpoint
...
ALTER TABLE `apps` ALTER COLUMN "updatedAt" TO "updatedAt" integer;--> statement-breakpoint
ALTER TABLE `artifactsGroups` ALTER COLUMN "createdAt" TO "createdAt" integer;--> statement-breakpoint
ALTER TABLE `artifactsGroups` ALTER COLUMN "updatedAt" TO "updatedAt" integer;--> statement-breakpoint
ALTER TABLE `organizations` ALTER COLUMN "createdAt" TO "createdAt" integer;--> statement-breakpoint
ALTER TABLE `organizations` ALTER COLUMN "updatedAt" TO "updatedAt" integer;--> statement-breakpoint
ALTER TABLE `users` ALTER COLUMN "createdAt" TO "createdAt" integer;--> statement-breakpoint
ALTER TABLE `users` ALTER COLUMN "updatedAt" TO "updatedAt" integer;