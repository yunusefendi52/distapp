...
ALTER TABLE `apps` ALTER COLUMN "createdAt" TO "createdAt" integer NOT NULL DEFAULT '"1970-01-01T00:00:00.000Z"';--> statement-breakpoint
...
ALTER TABLE `apps` ALTER COLUMN "updatedAt" TO "updatedAt" integer NOT NULL DEFAULT '"1970-01-01T00:00:00.000Z"';--> statement-breakpoint
ALTER TABLE `artifactsGroups` ALTER COLUMN "createdAt" TO "createdAt" integer NOT NULL DEFAULT '"1970-01-01T00:00:00.000Z"';--> statement-breakpoint
ALTER TABLE `artifactsGroups` ALTER COLUMN "updatedAt" TO "updatedAt" integer NOT NULL DEFAULT '"1970-01-01T00:00:00.000Z"';--> statement-breakpoint
ALTER TABLE `organizations` ALTER COLUMN "createdAt" TO "createdAt" integer NOT NULL DEFAULT '"1970-01-01T00:00:00.000Z"';--> statement-breakpoint
ALTER TABLE `organizations` ALTER COLUMN "updatedAt" TO "updatedAt" integer NOT NULL DEFAULT '"1970-01-01T00:00:00.000Z"';--> statement-breakpoint
ALTER TABLE `users` ALTER COLUMN "createdAt" TO "createdAt" integer NOT NULL DEFAULT '"1970-01-01T00:00:00.000Z"';--> statement-breakpoint
ALTER TABLE `users` ALTER COLUMN "updatedAt" TO "updatedAt" integer NOT NULL DEFAULT '"1970-01-01T00:00:00.000Z"';